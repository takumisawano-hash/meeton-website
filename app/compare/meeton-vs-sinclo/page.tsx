...
export const metadata: Metadata = {
  title: 'sinclo と Meeton ai を比較 | AI SDR への乗り換え評価ガイド',
  description:
...
const config: CompareConfig = {
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        '機能レイヤーが異なるため単純比較は困難ですが、Meeton ai は「商談予約まで完結する AI SDR」として、シナリオ型 chatbot 単体と比べて投資対効果 (商談化 ROI) ベースで評価されることが多いツールです。具体的な見積りはデモ時に、想定リード数・商談単価をもとに ROI 試算込みでご案内します。',
    },
    {

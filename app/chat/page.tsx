...
const data = PRODUCTS.chat;
export const revalidate = 3600;

export const metadata: Metadata = {
  title: { absolute: data.metaTitle },
  description: data.metaDescription,
  alternates: altLanguages("/chat/", 'ja'),
  openGraph: { title: data.metaTitle, description: data.metaDescription, url: "https://dynameet.ai/chat/", type: "website" },
};
...
const breadcrumb = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: data.productName, item: "https://dynameet.ai/chat/" },
  ],
};

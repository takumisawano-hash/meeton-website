...
const FAQ = [
  ...
  {
    q: "計算の根拠は？",
    a: "入力した月間訪問数・CV率・商談化率に対し、去る訪問者の一部（保守的に1.5%）を会話でリード化し、商談化率を利用企業ベンチ（最大60%。業界平均は約20%）を上限に引き上げた場合を試算します。すべて参考値で、実値は運用により変動します。",
  },
  {
    q: "登録やメールは必要ですか？",
    a: "不要です。入力するとその場で結果が表示されます。結果の控えが欲しい場合のみ任意でメールを入力できます。",
  },
];
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 20 }}>
          <Card>
            ...
            <p style={{ fontSize: 15, lineHeight: 1.8, color: "var(--text)", margin: 0 }}>
              いまフォームに辿り着かず黙って去る訪問者の一部（保守的に1.5%）を、AIチャットが会話で掴んでリード化します。
            </p>
          </Card>
          <Card>

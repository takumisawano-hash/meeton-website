...
const data = PRODUCTS.calendar;
export const revalidate = 3600;

export const metadata: Metadata = {
  title: { absolute: data.metaTitle },
  description: data.metaDescription,
  alternates: altLanguages("/calendar/", 'ja'),
  openGraph: { title: data.metaTitle, description: data.metaDescription, url: "https://dynameet.ai/calendar/", type: "website" },
};
...
const breadcrumb = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: data.productName, item: "https://dynameet.ai/calendar/" },
  ],
};

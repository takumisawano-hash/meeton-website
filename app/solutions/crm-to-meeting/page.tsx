...
const config: SolutionLpConfig = {
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        'いいえ。Meeton Email は事前定義された配信ポリシー (停止条件・送信頻度・配信時間帯) に従い、過去 12 ヶ月以内に opt-out 履歴がある contact は除外。送信前に必ず人間のレビュー段階を入れる承認フロー運用も選べます。',
    },
    {
      question: 'セキュリティはどうなっていますか？',
      answer:
        'ISMS 認証は審査合格済み・認証発行待ちの段階です。顧客データは AES-256 で保管、社内アクセスは最小権限。HubSpot / Salesforce との連携も official OAuth scope のみを要求し、データ書き戻し範囲は管理画面で個別 ON/OFF できます。セキュリティチェックシート対応、NDA 締結、アクセス権限管理にも個別対応可能。詳細は情報セキュリティポリシーを参照してください。',
    },
  ],
  finalCta: {

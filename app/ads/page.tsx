...
const data = PRODUCTS.ads;
export const revalidate = 3600;

export const metadata: Metadata = {
  title: { absolute: data.metaTitle },
  description: data.metaDescription,
  alternates: altLanguages("/ads/", 'ja'),
  openGraph: { title: data.metaTitle, description: data.metaDescription, url: "https://dynameet.ai/ads/", type: "website" },
};
...
const breadcrumb = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: data.productName, item: "https://dynameet.ai/ads/" },
  ],
};

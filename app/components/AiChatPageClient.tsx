...
const faqData = [
  { q: 'CRM 上の過去履歴も会話に活かせますか？', a: 'はい。Meeton Live は CRM 上の過去メモ・閲覧履歴・資料 DL 履歴・最終接触日まで全文脈として把握し、再訪リードに対して文脈に沿った会話を再開します。さらに、Meeton Email が CRM 上の休眠リードの再検討シグナルを検知し、再訪したタイミングで Live が自動起動して再エンゲージできます。' },

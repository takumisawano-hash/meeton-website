...
const securityFeatures = [
  {
    eyebrow: 'Compliance',
    title: 'ISO 27001 および ISO 27017 認証取得に向けたステージ2審査完了のお知らせ',
    description:
      '当社は、情報セキュリティマネジメントシステムの国際規格「ISO/IEC 27001」およびクラウドセキュリティの国際規格「ISO/IEC 27017」の認証取得に向け、第三者審査機関（SGSジャパン株式会社）によるステージ2審査を完了し、「認証推奨」の判定をいただきました。現在、正式な認証登録の手続きを進めており、2026年6月頃の証明書発行を見込んでおります。（※認証登録完了後、こちらに認証マークを掲示いたします）',
  },
  {

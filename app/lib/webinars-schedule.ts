...
export const WEBINAR_SCHEDULE: WebinarSchedule[] = [
  {
    ...
    date: '2026-06-18',
    dateLabel: '6 月 18 日(木) 14:00 - 15:00 JST',
    description:
      'リードはあるのに商談数が伸びない B2B 企業向けの thought leadership ウェビナー。業界統計と独自分析からパイプラインの "見えない損失" を分解し、修復のフレームワークを提示します。',
    learnings: [
      'B2B パイプライン上で MQL→SQL 間に失われる平均 80% のリード、その内訳と発生メカニズム',
      '"見えない損失" を計測する 5 つの指標 (Speed to Lead / Touch 数 / コンテンツ消費 / 再訪率 / 温度減衰)',
      'ロスの大きい 3 つの転換点 (初動 / 育成 / 再エンゲージ) と、それぞれの修復アプローチ',
      '実装の論点 — 人手で解く範囲と AI で解く範囲の切り分け方',
    ],
    agenda: [
      { minutes: 5, topic: 'なぜ "リードはあるのに商談化しない" のか — 業界統計の現在地' },
      { minutes: 12, topic: 'パイプライン分解モデル — 5 段階で見える損失の正体' },
      { minutes: 10, topic: '損失が起きる 3 つの転換点 (初動 / 育成 / 再エンゲージ)' },
      { minutes: 10, topic: '修復のフレームワーク — 人手と AI の境界線' },
      { minutes: 10, topic: 'Live Q&A — 参加者の状況に合わせた個別アドバイス' },
    ],
  ...
  },
  {
    ...
    date: '2026-07-16',
    dateLabel: '7 月 16 日(木) 14:00 - 15:00 JST',
    description:
      'Harvard Business Review の Speed to Lead 古典研究と最新の B2B 実証データから、初動応答時間が商談化率にもたらす定量影響を解説。Japan B2B 文脈での適用ポイントも掘り下げます。',
    learnings: [
    ...
    agenda: [
      { minutes: 5, topic: 'なぜ Speed to Lead は B2B で再注目されているか' },
      { minutes: 10, topic: 'Harvard 研究の 5 分の壁 — 数字の中身を分解する' },
      { minutes: 10, topic: 'Japan 市場での実証 — 業界別・組織規模別の感応度' },
      { minutes: 12, topic: '実装アーキテクチャ 3 パターン — 人手 / 半自動 / フル自動' },
      { minutes: 10, topic: 'Live Q&A' },
    ],
    speaker: DEFAULT_SPEAKER,
  },
  {
    ...
    date: '2026-08-20',
    dateLabel: '8 月 20 日(木) 14:00 - 15:00 JST',
    description:
      'B2B のメール開封率が下落するなか、温度低リードを失わずに育成するためのナーチャリング設計を、構造化されたフレームと業界データから解説します。',
    learnings: [
      'なぜ B2B のメールナーチャリングは形骸化したか — 開封率 5% の構造要因',
      '温度低リードを失わないための 4 段階モデル (Re-attention / Re-context / Re-engage / Re-route)',
      'メール以外のナーチャリング媒体 — Web 接客 / コンテンツライブラリ / リターゲ広告の使い分け',
      'ナーチャリング ROI を計測する指標と、長期育成のリーディングインジケータ',
    ],
    agenda: [
      { minutes: 5, topic: 'なぜメールナーチャリングは死んだのか' },
      { minutes: 12, topic: '4 段階モデル — Re-attention から Re-route まで' },
      { minutes: 10, topic: '代替媒体の組み合わせ方 — チャネルマトリクス' },
      { minutes: 10, topic: 'ROI 計測設計 — リーディングインジケータの選定' },
      { minutes: 10, topic: 'Live Q&A' },
    ],
    speaker: DEFAULT_SPEAKER,
  },

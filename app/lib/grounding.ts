...
export const GROUNDING: Fact[] = [
  ...
  { claim: "料金プラン", value: "月額12万円〜の3プラン。リード獲得プラン（掴む・育てる＝Chat/Ads/Library／¥12万〜）/ 商談獲得プラン（+商談化）/ オールインワンプラン（+追客）。上位2プランはお問い合わせ。料金は月間トラフィックと機能で変動", source: "Meeton ai 料金", clusters: ["ai-sdr"] },
];

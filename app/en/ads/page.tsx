...
const data = PRODUCTS_EN.ads;
export const revalidate = 3600;

export const metadata: Metadata = {
  title: { absolute: data.metaTitle },
  description: data.metaDescription,
  alternates: altLanguages("/ads/", "en"),
  openGraph: {
    images: EN_OG_IMAGE,
    title: data.metaTitle,
    description: data.metaDescription,
    url: "https://dynameet.ai/en/ads/",
    type: "website",
    locale: ogLocale("en"),
  },
};
...
const breadcrumb = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: data.productName, item: "https://dynameet.ai/en/ads/" },
  ],
};

...
// /en/use-cases/webinar-follow-up/ — English twin of /use-cases/webinar-follow-up/.
// Faithful translation of the JA moment LP; renders through PlaybookLP.

export const revalidate = 3600;

const SLUG = "webinar-follow-up";
...
export default function WebinarFollowUpUseCasePageEn() {

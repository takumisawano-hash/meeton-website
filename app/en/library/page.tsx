...
const data = PRODUCTS_EN.library;
export const revalidate = 3600;

export const metadata: Metadata = {
  title: { absolute: data.metaTitle },
  description: data.metaDescription,
  alternates: altLanguages("/library/", "en"),
  openGraph: {
    title: data.metaTitle,
    description: data.metaDescription,
    url: "https://dynameet.ai/en/library/",
    type: "website",
    locale: ogLocale("en"),
  },
};
...
const breadcrumb = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: data.productName, item: "https://dynameet.ai/en/library/" },
  ],
};

...
const data = PRODUCTS_EN.email;
export const revalidate = 3600;

export const metadata: Metadata = {
  title: { absolute: data.metaTitle },
  description: data.metaDescription,
  alternates: altLanguages("/email/", "en"),
  openGraph: {
    title: data.metaTitle,
    description: data.metaDescription,
    url: "https://dynameet.ai/en/email/",
    type: "website",
    locale: ogLocale("en"),
  },
};
...
const breadcrumb = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: data.productName, item: "https://dynameet.ai/en/email/" },
  ],
};

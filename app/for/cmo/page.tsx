...
const config: PersonaConfig = {
  ...
  moduleMapping: [
    ...
    },
    {
      key: 'email',
      reason:
        'インバウンドメールに AI が 24/7 即時返信し、ナーチャリング配信にも AI が反応。MQL → SQL 落差の主因「初動遅延」を構造的に消します。 加えて、Meeton Email は CRM に眠る過去 MQL・失注リードの再検討シグナル（サイト再訪、料金閲覧、メール再開封等）を検知し、文脈に沿って 1:1 再アプローチ。マーケが過去に集めたリード資産まで商談化に変えます。',
    },
    {
      key: 'calendar',
      reason:
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'はい。Meeton Email が CRM 上の過去 MQL・失注リード・休眠 contact の再検討シグナル（サイト再訪、料金ページ閲覧、メール再開封など）を検知し、AI 動的判断で個別に再アプローチします。マーケが過去に獲得したリード資産を、人手をかけずに再商談化できます。詳細は CRM-to-Meeting ページをご覧ください。',
    },
  ],
  accent: '#04cb78',

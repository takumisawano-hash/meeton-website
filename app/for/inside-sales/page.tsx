...
const config: PersonaConfig = {
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Meeton Email が AI で自動化するため、IS が手動で追う必要はありません。Meeton Intent が CRM データから再検討タイミングを検知し、Meeton Email が文脈に沿った再アプローチを実行。返信や再訪があった「温度の戻ったリード」だけが IS に通知されるため、対応すべきリードに集中できます。',
    },
  ],
  accent: '#0891b2',

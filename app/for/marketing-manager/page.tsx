...
const config: PersonaConfig = {
  ...
  moduleMapping: [
    ...
    },
    {
      key: 'email',
      reason:
        'インバウンドメール・問い合わせ返信・ステップ配信への返信まで AI が応答。シナリオ型 MA では届かない「文脈に沿った 1to1 ナーチャリング」が実現します。 MA の一斉配信では届かない CRM 内の休眠リード・過去 MQL も Meeton Email が AI で個別に再アプローチ。マーケが集めたリード資産を「リスト」で終わらせず、商談機会まで掘り起こします。',
    },
    {
      key: 'live',
      reason:

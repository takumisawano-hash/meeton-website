...
export default async function WebinarDetailPage({
  ...
  return (
    <div className="wb-root">
      ...
      <section className="wb-hero">
        ...
        <div className="wb-hero-inner">
          <div className="wb-eyebrow">
            ...
            Webinar
            <span className="wb-eyebrow-tag">{webinar.dateLabel}</span>
          </div>
          ...
          {webinar.speaker && (
            <div className="wb-speaker-card">
              ...
              <div className="wb-speaker-info">
                <div className="wb-speaker-name">{webinar.speaker.name}</div>
      ...
      {/* ── REGISTRATION ── */}
      <section id="register" className="wb-reg">
        <div className="wb-reg-inner">
          <div>
            ...
            <div className="wb-reg-side">
              <div className="wb-reg-trust">
                <div className="wb-reg-trust-l">Trust Signals</div>
                ...
                <div className="wb-reg-trust-row">
                  ...
                  <div className="wb-reg-trust-k">毎回の構成。Q&A 込み</div>
                </div>
                <div className="wb-reg-trust-row">
                ...
                <a
                  ...
                  style={{
                    ...
                    color: 'var(--w-green-deep)', textDecoration: 'none',
          ...
          <div className="wb-reg-card">
            ...
            <p className="wb-reg-card-sub">
              4 項目のみ。1 分で完了します。Zoom リンクは前日にメール送付します。
            </p>

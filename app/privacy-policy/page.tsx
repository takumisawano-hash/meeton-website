          ...
          >
            ...
            <Section title="第2条（個人情報の収集方法）">
              ...
              <ul style={{ paddingLeft: 24, marginTop: 12 }}>
                ...
                <li>（3）メールマガジンの登録時</li>
                <li>（4）本サービスの各機能（AIチャット、カレンダー予約フォーム、ポップアップ/バナー、その他の入力フォーム）を通じて、お客様のウェブサイトの訪問者が情報（氏名、メールアドレス、電話番号、会社名、役職、部署名等）を入力した場合</li>
                <li>（5）本サービスのメール配信・アウトリーチ機能を通じて訪問者の行動データ（メール開封、リンククリック等）を取得する場合</li>
                <li>（6）本サービスの機能により、お客様のウェブサイト上で訪問者の行動データ（閲覧ページURL、滞在時間、スクロール深度、セッション情報、各機能へのエンゲージメント、ダウンロードセンターにおける資料の閲覧ページ・閲覧時間等）、IPアドレス、デバイス情報、ブラウザ情報、Cookie・セッション情報を自動的に取得する場合</li>
                <li>（7）IPアドレス等の情報に基づき企業属性情報（企業名、業種、所在地、従業員規模等）を推定する場合</li>
                <li>（8）お客様がご指定する外部CRM（HubSpot、Salesforce等）との連携を通じてデータを送受信する場合</li>
            ...
            <Section title="第3条（個人情報の利用目的）">
              ...
              <ul style={{ paddingLeft: 24, marginTop: 12 }}>
                <li>（1）当社サービスの提供・運営のため（AIチャットボットによる自動応答の生成、商談機会の創出、カレンダー連携による日程調整、メール配信によるナーチャリングを含む）</li>
                <li>（2）お問い合わせへの対応のため</li>
                <li>（3）サービスに関するご案内やお知らせのため</li>
                <li>（4）サービスの改善・新サービスの開発のため（匿名化されたデータに基づくAIモデルの改善を含む）</li>
                <li>（5）お客様への利用状況レポートの提供のため</li>
                <li>（6）お客様がご指定する外部CRM等へのデータ連携・転送のため</li>
                <li>（7）サービスのセキュリティ維持および不正利用の防止のため</li>
            ...
            <Section title="第6条（個人情報の開示・訂正・削除）">
              <p>
                1. お客様は、当社に対して、ご自身の個人情報の開示、訂正、追加、削除、利用停止を請求することができます。請求を受けた場合、当社は本人確認を行った上で、合理的な期間内に対応いたします。
              </p>
              <p style={{ marginTop: 12 }}>
                2. 本サービスの利用契約が終了した場合、当社は当社の定める期間内（原則として終了から90日以内）に、お客様が登録した識別可能な個人データ（氏名、メールアドレス等）を削除または匿名化いたします。
              </p>
              <p style={{ marginTop: 12 }}>
                3. 前項の規定にかかわらず、個人を特定できないように加工された行動履歴、統計情報、およびメタデータについては、サービスの向上や分析の目的で、契約終了後も保持および利用させていただきます。
              </p>
              <p style={{ marginTop: 12 }}>
                4. お客様が契約終了時にデータの返還または個別の削除を希望される場合は、契約終了日までに当社にご通知ください。終了日以降の個別の削除要請には、当社の合理的な範囲でのみ対応いたします。
              </p>
            </Section>

...
const STAGES: PillarStage[] = [
  ...
  },
  {
    ...
    body: 'ランディングページ・ブログ・ホワイトペーパー・動画・ROI シミュレーターなどで、訪問者の課題解決に貢献するコンテンツを提供し、「自社に解像度高く知ってもらう」段階です。ここで滞在時間・ページ回遊・再訪が増えるかが、後続の CV 率を大きく左右します。',
    link: { href: '/roi-simulator/', label: 'ROI シミュレーター例を見る' },
  },
  {
    num: '03',
    label: 'Lead capture',

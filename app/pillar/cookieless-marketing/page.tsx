...
const STAGES: PillarStage[] = [
  ...
  },
  {
    ...
    body: 'ホワイトペーパー DL・ROI シミュレーター・ナレッジベースなど、訪問者が能動的に情報提供する瞬間を増やします。広告主導の獲得から、コンテンツ主導の獲得へ重心を移すと、ファネル全体がクッキー非依存になります。',
    link: { href: '/roi-simulator/', label: 'ROI シミュレーター例' },
  },
  {
    num: '04',
